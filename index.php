    ...
    <div class="flexslider basicslider">
      <ul class="slides">
        ...
        <li>
          <article>
            <p></p>
            <h3 class="heading">Цусан дахь сахрын хэмжээ</h3>
        ...
        <li>
          <article>
            ...
            <p>Эрүүл зөв хооллох, Идэвхтэй дасгал хөдөлгөөн хийх, Илүүдэл жингүй байх, илүүдэл жинтэй бол түүнийгээ хасах, Хорт зуршлаас татгалзах.</p>
            <footer><a class="btn" href="login/index.php">Дэлгэрэнгүй</a></footer>
          </article>
        </li>
      </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <p class="btmspace-50 justified">Чихрийн шижин (лат. Diabetes mellitus) нь хүний биеийн нойр булчирхай хангалттай хэмжээний инсулин боловсруулж чадахгүй, эсвэл боловсорсон инсулин нь бие эсүүдэд нөлөөлж чадахгүй болсон үед үүсдэг бодисын солилцооны бүлэг өвчин. Чихрийн шижингийн үед хүний цусан дахь сахрын хэмжээ өндөр болдог. Цусан дахь сахрын төвшин их байхын сонгодог шинж тэмдгүүд нь, их шээх (полиури), их уух (полидипси) ба идэмхий (полифаги) болдог.</p>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/serch.gif');">
  <article class="hoc container clear"> 
    ...
    <div class="three_quarter first">
      ...
      <p class="nospace">хэрэв танд  шинж тэмдгүүд илэрч байвал</p>
    </div>
...
<div class="wrapper bgded overlay light" style="background-image:url('images/demo/backgrounds/sigar.jpg');">
  <section class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <h3 class="heading">Цусан дахь сахрын хэмжээ түүнээс урьдчилан сэргийлэх</h3>
      <p>Цусан дахь сахрын хэмжээ түүнээс урьдчилан сэргийлэх.</p>
    </div>
...
<div class="wrapper row3">
  <article class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <p>Цусны сахрын хэмжээ 15 мол/-ээс их бол “маш их” гэж үзээд, анхаарал хандуулах хэрэгтэй.</p>
    </div>
    <figure>
      <ul class="nospace group logos">
        <li class="one_quarter first"><a href="#"><img src="images/demo/zur1.png" alt=""></a></li>
        <li class="one_quarter"><a href="#"><img src="images/demo/zurag5.png" alt=""></a></li>
        <li class="one_quarter"><a href="#"><img src="images/demo/zur3.png" alt=""></a></li>
        <li class="one_quarter"><a href="#"><img src="images/demo/zur4.png" alt=""></a></li>
      </ul>
    </figure>
    <!-- ################################################################################################ -->
  </article>
  ...
  <article class="hoc container"> 
    ...
    <ul class="nospace group">
      <li class="one_half first borderedbox inspace-15">
        <blockquote>Инсулины туйлын дутагдал (нойр булчирхайн үйл ажиллагаа алдагдсанаас үүснэ). Үүний улмаас цусан дахь сахрын хэмжээг зохицуулдаг инсулин нэртэй дааврыг ялгаруулахаа больдог.</blockquote>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <ul class="nospace group">
      <li class="one_third first">
        <article class="excerpt"><a href="#"><img class="inspace-10 borderedbox" src="images/demo/xconvert.com.png" alt=""></a>
      ...
      <li class="one_third">
        <article class="excerpt"><a href="#"><img class="inspace-10 borderedbox" src="images/demo/xconvert.com (1).png" alt=""></a>
          <div class="excerpttxt">
            <ul>
      ...
      <li class="one_third">
        <article class="excerpt"><a href="#"><img class="inspace-10 borderedbox" src="images/demo/xconvert.com (2).png" alt=""></a>
          <div class="excerpttxt">
            <ul>
