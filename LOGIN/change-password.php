    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE code='{$_GET['reset']}'")) > 0) {
        if (isset($_POST['submit'])) {
            ...
            if ($password === $confirm_password) {
                ...
                $msg = "<div class='alert alert-danger'>Нууц үг болон баталгаажуулах нууц үг таарахгүй байна.</div>";
            }
        }
    } else {
        $msg = "<div class='alert alert-danger'>Дахин тохируулах холбоос таарахгүй байна.</div>";
    }
} else {
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <div class="social-icons">
                            <p>Буцах! <a href="index.php">Login</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
